var store={
	...
	"url":/((?:(?:https?|ftps?|sftp|ssh|smtp|file|scp|):\/\/)|())(?:\S+(?::\S*)?@)?(?:(?!10(?:\.\d{1,3}){3})(?!127(?:\.\d{1,3}){3})(?!169\.254(?:\.\d{1,3}){2})(?!192\.168(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z0-9]+-?)*[a-z0-9]+)(?:\.(?:[a-z0-9]+-?)*[a-z0-9]+)*(?:\.(?:[a-z]{2,})))(?::\d{2,5})?(?:\/[^\s]*)?/g,
	...
	"currency":/(\s|^)(?=\s?)((₡|(R\$)|(kr)|(Rp)|Rs|₩|₨|฿|(руб)|(RM)|R|₹|¥|€|£|\$)(\.?)(\s*\d+(,\d+)*(\.\d+)?\s?(lakhs|lakh|million|billion|thousand)?))(?=\s)|((\d+(,\d+)*(\.\d+)?\s*(lakhs|lakh|million|billion|thousand)?)\s?(\$|rupees|rupee|£|€|¥|₹|(RM)|Rs|(руб)|฿|₨|₩|(Rp)|(kr)|(R\$)|R|₡|dollars|dollar|pounds|pound|baht))/gi,
	...
	"time":/(\d{13})|((([0][0-9])|([1][0-2]))(:|-|\.)(([0-5])([0-9]))(\s|)(am|a.m|pm|p.m))|((\+|-|)([1-9]|([1][0-2]))(\s|)(am|a.m|pm|p.m))|((\+|-|)([0-9]|([1][0-2]))(\s|)(o'clock))|((\+|-|)(([0][0-9])|([1][0-9])|([2][0-4]))(:|-|\.)(([0-5])([0-9]))((?=\s)|(?=(:|-|\.))(:|-|\.)[0-5][0-9])(((?=\s)\sGMT(\+|-)(([0-1][0-9])|([2][0-4]))(:|-|\.|)([0-5][0-9]))|((\s|)(\+|-)(([0-1][0-9])|([2][0-4]))(:|-|\.)([0-5][0-]))|))/gi
};
var months={
	"january":"01",
	"jan":"01",
