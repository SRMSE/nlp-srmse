var store={
	...
	"bullets":/(\b([a-zA-Z]{1,2}|[0-9]{1,2}|[mdclxviMDCLXVI]{1,3})\.\)\s)|(\b([a-zA-Z]{1,2}\.|[0-9]{1,2}(\.[^0-9])|[mdclxviMDCLXVI]{1,3}\.))|(\b\(([a-zA-Z]{1,2}|[0-9]{1,2}|[mdclxviMDCLXVI]{1,3})\))|(\(\b([a-zA-Z]{1,2}|[0-9]{1,2}|[mdclxviMDCLXVI]{1,3})\.\))|(\b([a-zA-Z]{1,2}|([0-9]{1,2})|[mdclxviMDCLXVI]{1,3})\))/g
};
exports.store=store;
